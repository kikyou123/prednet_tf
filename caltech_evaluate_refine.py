...
DATA_DIR = '/home/data/houruibing/data/CalTech_Pedestrian/data'
SAVE_DIR = './caltech'
saves_dir = os.path.join(SAVE_DIR, 'refine/')
if not os.path.exists(saves_dir):
    os.makedirs(saves_dir)
saves_dir1 = os.path.join(SAVE_DIR, 'no_refine/')
if not os.path.exists(saves_dir1):
    os.makedirs(saves_dir1)

data_dir = os.path.join(DATA_DIR, 'sample_data_3', 'val')
...
for i in range(len(data_list)):
    test_file = os.path.join(DATA_DIR, 'sample_data_3', 'val', data_list[i])
    test_sources = os.path.join(DATA_DIR, 'sample_source_3', 'val', 'source-' + data_list[i])
